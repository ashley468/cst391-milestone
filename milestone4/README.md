...
# Changes/Updates
-For the milestone, I'd be focusing on three different categories for the music store, though for this section I only added the instrument and not the accessory nor media as it would over-complicate the program and possibly be a bit confusing. Though, it's a possibility that in future milestones I will implement these two categories for the music store. 

# Table Updates

|**Update** | **Description** | **Status** | **Known Issues** |
|-----------|-----------------|-------------|-----------------|
|Different Categories | Did not include other two categories | Incomplete | add two categories in future milestones |
